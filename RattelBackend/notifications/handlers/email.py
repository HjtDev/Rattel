...
class EmailHandler:
    ...
    def __init__(self, provider_class: Type[BaseEmailProvider], api_key: str = None):
        """
        ...
        self.provider = self._initialize_provider(provider_class)
    
    def _initialize_provider(self, provider_class: Type[BaseEmailProvider]) -> BaseEmailProvider:
