...
SMS_API_NEW_TICKET_ALERT_TEMPLATE = config('SMS_API_NEW_TICKET_ALERT_TEMPLATE')
SMS_API_NEW_AUTOMATIC_PLAN_REQUEST_ALERT_TEMPLATE = config('SMS_API_NEW_AUTOMATIC_PLAN_REQUEST_ALERT_TEMPLATE')
SMS_API_AUTOMATIC_PLAN_DELAYED_ALERT_TEMPLATE = config('SMS_API_AUTOMATIC_PLAN_DELAYED_ALERT_TEMPLATE')
