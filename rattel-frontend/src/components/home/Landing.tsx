                    ...
                    <div
                            ...
                            <LoadingSkeleton isLoading={isLoading} Content={() => (
                                <>
                                    ...
                                    <span className="position-relative">
                                        {data?.brushed_title}
                                        <span
                                            className="position-absolute top-50 start-50 translate-middle ms-3 z-index-n1">
                                                <svg width="300px" height="62.1px" enableBackground="new 0 0 366 62.1"
                        ...
                        <div className="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
                            <LoadingSkeleton isLoading={isLoading} Content={() => (
                                <>
                                    {data?.link?.url && (
                                        <a href={data.link.url} className="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0">
                                            {data.link.name}
                                        </a>
                                    )}
                                </>
              ...
              <i className="fas fa-envelope text-white">
                                ...
                                <div className="text-start ms-3">
                                    <h6 className="mb-0 text-white">
                                        <LoadingSkeleton isLoading={isLoading} Content={() => data?.message_title} width={167} height={19} />
                                        <span className="ms-4">
