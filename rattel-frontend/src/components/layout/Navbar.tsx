                    ...
                    <div className="navbar-collapse w-100 collapse" id="navbarCollapse">
                        <ul className="navbar-nav navbar-nav-scroll me-auto">
                            <li className="nav-item dropdown dropdown-menu-shadow-stacked">
                                <a className="nav-link bg-primary bg-opacity-10 rounded-3 text-primary px-3 py-3 py-xl-0"
                ...
                دسته بندی
                                ...
                                <ul className="dropdown-menu" aria-labelledby="categoryMenu">
                                    ...
                                    <li className="dropdown-submenu dropend">
                                        ...
                                        <div className="dropdown-menu dropdown-menu-start dropdown-width-lg"
                                             data-bs-popper="none">
                                            <div className="row p-4">
                                                ...
                                                <div className="col-xl-6 col-xxl-4 mb-4 mb-xl-0">
                                                    ...
                                                    <div className="d-flex mb-4 position-relative">
                                                        <img src="assets/images/client/uni-logo-01.svg"
                                                             className="icon-md"/>
                                                        <div className="ms-3">
                                                            <a className="stretched-link h6 mb-0 fw-normal" href="#">
                                                    ...
                                                    <div className="d-flex mb-4 position-relative">
                                                        <img src="assets/images/client/uni-logo-02.svg"
                                                             className="icon-md"/>
                                                        <div className="ms-3">
                                                            <a className="stretched-link h6 mb-0 fw-normal" href="#">
                                                    ...
                                                    <div className="d-flex mb-4 position-relative">
                                                        <img src="assets/images/client/uni-logo-03.svg"
                                                             className="icon-md"/>
                                                        <div className="ms-3">
                                                            <a className="stretched-link h6 mb-0 fw-normal" href="#">
                                                    ...
                                                    <div className="d-flex position-relative">
                                                        <img src="assets/images/client/uni-logo-04.svg"
                                                             className="icon-md"/>
                                                        <div className="ms-3">
                                                            <a className="stretched-link h6 mb-0 fw-normal" href="#">
                                            ...
                                            <div className="row">
                                                <div className="col-12">
                                                    <div
                                                        ...
                                                        <figure
                                                            className="position-absolute bottom-0 end-0 mb-n4 d-none d-md-block">
                                                            <svg width="92.6px" height="135.2px">
                                                                ...
                                                                <polygon className="fill-warning opacity-6"
                                                        ...
                                                        <div className="card-body">
                                                            <h5 className="card-title text-white mb-2">
                                                                دسترسی به 25 هزار دوره آنلاین از 120 موسسه، از امروز
                                                                شروع کنید!
                                                            </h5>
                                                            <p className="text-white text-opacity-75">
                                                                در اینجا توضیحاتی در مورد ویژگی های برتر ارائه شده است
                                                                که به کاربران امکان می دهد از مزایایی برخوردار شوند و در
                                                                هزینه های زیادی صرفه جویی کنند
                                                            </p>
                                    ...
                                    <li>
                                        <a className="dropdown-item bg-primary text-primary bg-opacity-10 rounded-2 mb-0"
                                           href="#">
                                            مشاهده همه
                                        </a>
                                    </li>
                        ...
                        <ul className="navbar-nav navbar-nav-scroll me-auto">
                            <li className="nav-item dropdown">
                                <a className="nav-link dropdown-toggle active" href="#" id="demoMenu"
                                ...
                                <ul className="dropdown-menu" aria-labelledby="pagesMenu">
                                    <li className="dropdown-submenu dropend">
                                        ...
                                        <ul className="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                            ...
                                            <li>
                                                <a className="dropdown-item" href="course-detail-module.html">
                                                    جزئیات نسخه 4
                                                </a>
                                            </li>
                                            <li>
                                                <a className="dropdown-item" href="course-video-player.html">
                                                    جزئیات نسخه 5
                                                </a>
                                            </li>
                                        </ul>
                    ...
                    جدید
                                    ...
                                    <li className="dropdown-submenu dropend">
                                        ...
                                        <ul className="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                            ...
                                            <li>
                                                <a className="dropdown-item" href="shop-product-detail.html">
                                                    جزئیات دوره
                                                </a>
                                            </li>
                                            <li>
                                    ...
                                    <li className="dropdown-submenu dropend">
                                        ...
                                        <ul className="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                            ...
                                            <li>
                                                <a className="dropdown-item" href="university-admission-form.html">
                                                    پذیرش
                                                </a>
                                            </li>
                                        </ul>
                            ...
                            <li className="nav-item dropdown">
                                <a className="nav-link dropdown-toggle" href="#" id="accounntMenu"
                                   data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    داشبورد
                                </a>
                                <ul className="dropdown-menu" aria-labelledby="accounntMenu">
                                    <li className="dropdown-submenu dropend">
                                        ...
                                        <ul className="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                            ...
                                            <li>
                                                <a className="dropdown-item" href="instructor-manage-course.html">
                                            ...
                                            <li>
                                                <a className="dropdown-item" href="instructor-create-course.html">
                                            ...
                                            <li>
                                                <a className="dropdown-item" href="instructor-studentlist.html">
                                    ...
                                    <li className="dropdown-submenu dropend">
                                        ...
                                        <ul className="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                            ...
                                            <li>
                                                <a className="dropdown-item" href="student-subscription.html">
                                            ...
                                            <li>
                                                <a className="dropdown-item" href="student-course-list.html">
                                                    <i className="bi bi-basket-fill fa-fw me-1">
                                                    </i>
                                                    لیست دوره ها
                                                </a>
                                            ...
                                            <li>
                                                <a className="dropdown-item" href="student-course-resume.html">
                                            ...
                                            <li>
                                                <a className="dropdown-item" href="student-payment-info.html">
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="instructor-edit-profile.html">
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="instructor-delete-account.html">
                                ...
                                <div className="dropdown-menu dropdown-menu-end" data-bs-popper="none">
                                    <div className="row p-4 g-4">
                                        ...
                                        <div className="col-xl-6 col-xxl-3">
                                            ...
                                            <hr/>
                                            <div
                                                className="mb-2 position-relative bg-primary-soft-hover rounded-2 transition-base p-3">
                                        ...
                                        <div className="col-xl-6 col-xxl-3">
                                            ...
                                            <div className="row g-2 justify-content-center mt-3">
                                                ...
                                                <div className="col-6 col-sm-4 col-xxl-6">
                                                    <a href="#">
                                                        <img src="assets/images/client/app-store.svg"
                            ...
                            <li className="nav-item dropdown">
                                <a className="nav-link" href="#" id="advanceMenu" data-bs-toggle="dropdown"
                                   aria-haspopup="true" aria-expanded="false">
                                ...
                                <ul className="dropdown-menu dropdown-menu-end min-w-auto" data-bs-popper="none">
                                    ...
                                    <li>
                                        <a className="dropdown-item" href="https://www.rtl-theme.com/" target="_blank">
